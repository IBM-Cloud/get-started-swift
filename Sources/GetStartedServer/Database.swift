...
struct DatabaseManager {
    ...
    init(_ url: String, credentials: CloudantCredentials) {
        self.baseURL = URL(string: url)!
        self.credentials = credentials
    }
    
    func createDB(_ handler: @escaping (Bool) -> Void) {
    ...
    func findAll(_ handler: @escaping ([String]?) -> Void) {
    ...
    func insert(_ name: String, success: @escaping ([String: Any]) -> Void) {
