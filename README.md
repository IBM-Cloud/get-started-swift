...
You'll need a [Bluemix account](https://console.ng.bluemix.net/registration/) and the following tools. If you do not have the tools, you can follow the links to download them.
...
Now you're ready to start working with the simple Swift app, let's clone the repository and change to the directory to where the sample app is located.
